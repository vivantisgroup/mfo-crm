...
export default function PlatformRolesPage() {
 ...
 // Breadcrumbs deprecated per global SecondaryDock framework.
 ...
 return (
    <div className="flex flex-col absolute inset-0 overflow-hidden bg-canvas z-0">
      <main className="flex-1 flex flex-col min-h-0 relative animate-fade-in overflow-y-auto w-full px-4 lg:px-8 pt-6 pb-12">
