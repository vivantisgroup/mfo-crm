...
export default function TenantUsersPage() {
 ...
 <div className="header-search cursor-text max-w-md w-full" style={{ flex: 1 }}>
   ...
   <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search name or email…" className="flex-1 min-w-0 bg-transparent border-none outline-none text-[13px] text-primary placeholder-tertiary" />
 </div>
